...
#!/bin/sh
cd /usr/bin && MW_API_KEY=$MW_API_KEY TARGET=$TARGET MW_API_URL_FOR_RESTART=$MW_API_URL_FOR_RESTART MW_API_URL_FOR_YAML=$MW_API_URL_FOR_YAML $MW_AGENT_BINARY start
EOIF
...
#!/bin/sh
cd /usr/bin && MW_API_KEY=$MW_API_KEY MW_API_URL_FOR_RESTART=$MW_API_URL_FOR_RESTART MW_API_URL_FOR_YAML=$MW_API_URL_FOR_YAML $MW_AGENT_BINARY start
EOELSE
