...
echo "deb [arch=$MW_APT_LIST_ARCH signed-by=$MW_AGENT_HOME/apt/pgp-key-$MW_VERSION.public] http://keval:8080 stable main" | sudo tee /etc/apt/sources.list.d/$MW_APT_LIST > /dev/null
